...
```groovy
dependencies {
  implementation 'dev.nemecec.jrserial:jrserial:0.1.2'
}
```
...
**Gradle:**
```groovy
implementation 'dev.nemecec.jrserial:jrserial:0.1.2:lite'
```
...
**Gradle:**
```groovy
implementation 'dev.nemecec.jrserial:jrserial:0.1.2:linux-x86_64'
```
